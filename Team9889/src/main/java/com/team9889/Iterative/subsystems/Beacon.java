...
public class Beacon implements Subsystem {
    ...
    public void init(OpMode opMode, boolean auton) {
        try {
            //Servos
            RightBumper = opMode.hardwareMap.servo.get(Constants.kRightBeaconPresserId);
            LeftBumper = opMode.hardwareMap.servo.get(Constants.kLeftBeaconPresserId);
        ...
        try {
            //Color Sensor
            Color = opMode.hardwareMap.colorSensor.get(Constants.kColorSensorId);
