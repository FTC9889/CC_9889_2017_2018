...
/**
 * Created by joshua9889 on 10/15/2017.
 */
...
public class Camera {
    ...
    public boolean isCameraAvailable() {
        ...
        for (int i = 0; i < numberOfCameras; i++) {
            ...
            if (info.facing == android.hardware.Camera.CameraInfo.CAMERA_FACING_FRONT) { // Camera.CameraInfo.CAMERA_FACING_FRONT or BACK
                cameraId = i;
                break;
            }
        }
    ...
    public android.hardware.Camera openCamera(int cameraInfoType) {
        int cameraId = -1;
        android.hardware.Camera cam = null;
        int numberOfCameras = android.hardware.Camera.getNumberOfCameras();
        for (int i = 0; i < numberOfCameras; i++) {
    ...
    public void startCamera() {
        camera = openCamera(android.hardware.Camera.CameraInfo.CAMERA_FACING_FRONT);
